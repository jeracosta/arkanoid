  ...
  private:
    ...
    ensure_mesh_loaded_()
    {
        ...
        try
        {
            ...
            slot.mesh->recenter_to_origin();
            slot.mesh->normalize_to_max_extent(cfg_.normalize_extent);
