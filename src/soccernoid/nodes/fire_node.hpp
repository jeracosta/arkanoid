    ...
    class ParticlesNode_ : public ome::ParticleEmitterNode
    {
      private:
        static inline const ome::ParticleBlueprint blueprint_ = {
            .color = ome::SplineCurve<ome::Vec4f>(
                ome::SplineCurve<ome::Vec4f>::catmull_rom({
            ...
            .scale = ome::SplineCurve<float>(
                ome::SplineCurve<float>::catmull_rom({
                    { 0.00f, 0.05f },
                    { 0.10f, 0.20f },
                    { 0.30f, 0.35f },
                    { 0.50f, 0.30f },
            ...
            .origin           = { .mean = { 0.0f, 0.0f, 0.0f },
                                  .max_deviation = { 0.3f, 0.0f, 0.3f } },
            .initial_velocity = { .mean = { 0.0f, 2.0f, 0.0f },
                                  .max_deviation = { 0.5f, 0.8f, 0.5f } },
            .acceleration     = {},
