...
class EnergyExplosionNode : public ome::KinematicNode
{
    class Particles_ : public ome::ParticleEmitterNode
    {
        static inline const ome::ParticleScheme blueprint_ = {
            ...
            .initial_velocity = { ome::math::Sphere<3>({}, 12.0f), rng },

            .time_to_live = 0.5f,

            .color = ome::Spline<ome::Color>::catmull_rom({
                { 0.00f, ome::Color::white() },
                { 0.15f, colors.projectile },
                { 0.50f, ome::Color::rgba(0.0f, 0.8f, 0.0f, 0.6f) },
    ...
    class Light_ : public ome::LightNode<ome::PointLight>
    {
      private:
        ...
        static constexpr auto starting_light_ = ome::PointLight{
                    .color = {
                        ...
                        .diffuse  = ome::Color::rgb(0.2f, 1.0f, 0.3f),
                        .specular = ome::Color::rgb(0.1f, 0.8f, 0.2f),
                    },
                    .attenuation = { 0.0f, 0.0f, 0.15f },
                };
      ...
      public:
        ...
        on_tick_() override
        {
            ...
            light_.color.diffuse  = ome::Color::rgb(ome::Vec3f{ 0.2f, 1.0f, 0.3f } * intensity);
            light_.color.specular = ome::Color::rgb(ome::Vec3f{ 0.1f, 0.8f, 0.2f } * intensity);
